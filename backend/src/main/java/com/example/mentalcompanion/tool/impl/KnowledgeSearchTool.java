...
public class KnowledgeSearchTool implements AiTool {
    ...
    public KnowledgeSearchTool(ChromaClient chromaClient, ChromaProperties chromaProperties) {
    ...
    public ToolResult execute(ToolRequest request) {
        ...
        try {
            List<RagReference> references = chromaClient.search(query, topK == null ? chromaProperties.topK() : topK);
